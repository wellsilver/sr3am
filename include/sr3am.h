...
// New frame. Exact same as samUpdate but returns the ammonut of time it took to generate this frame (in microseconds). If no previous frame it uses window creation
